"""
Django settings for pers_47971 project.
...
WSGI_APPLICATION = 'pers_47971.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "pers_47971 API",
    "DESCRIPTION": "API documentation for pers_47971 App",
    "VERSION": "v1",
}
